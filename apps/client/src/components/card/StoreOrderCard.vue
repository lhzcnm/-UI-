...
import type { StoreOrderView } from '@desktop/pages/store/utils/types'
...
const style = tv({
  slots: {
    ...
    index: [
      'absolute -top-3 -left-3 text-xs text-white font-semibold px-3 py-1 rounded-lg shadow-md select-none z-10'
    ],
    content: [
