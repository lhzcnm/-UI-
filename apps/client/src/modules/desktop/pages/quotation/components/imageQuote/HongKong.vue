...
<template>
  <div class="h-screen">
    ...
    >
      ...
      <!-- 型号列表 -->
      <div
        v-for="(series, si) in store.HongKongNewData"
        :key="si"
        class="mb-2 bg-white dark:bg-gray-800 border dark:border-gray-700 overflow-hidden"
      >
        <div
          :class="quoteColors[4]"
        ...
        <div class="flex">
          <table class="w-full table-fixed border-collapse border text-center text-xs dark:border-gray-600">
            ...
            <thead class="bg-orange-50 dark:bg-orange-900/40 font-semibold">
              <tr>
                <th
