...
<!-- From Uiverse.io by AatreyuShau --> 
 <div class="bg-gray-200 w-full h-full">
     <section class="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 pointer-events-none ">
      ...
      <div class="flex items-center justify-center py-8 text-black text-lg font-medium">
