...
<template>
  <div class="space-y-3">
    <div class="space-y-1">
      <label class="inline-block mb-1 text-sm text-secondary-foreground">服务选择：</label>
    ...
    <div class="space-y-1">
      <label class="text-sm text-secondary-foreground">订单状态：</label>
      <XSegmented
        v-model="form.status"
    ...
    <div class="space-y-1">
      <label class="inline-block mb-1 text-sm text-secondary-foreground">提交时间：</label>
      <div class="flex items-center space-x-2">
    ...
    <div class="space-y-1">
      <label class="inline-block mb-1 text-sm text-secondary-foreground">IMEI/SN：</label>
      <XTextarea
