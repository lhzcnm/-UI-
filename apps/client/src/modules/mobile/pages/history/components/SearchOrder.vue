...
<template>
  <TheModal
    ...
    :title="localStore.localData['history_FilterOrders']" class="h-[78%]"
  >
    <BaseForm v-model="store.searchForm" class="px-4" />
    <div class="flex justify-end space-x-2 p-4">
      <XButton color="success" variant="soft" @click="handleReset">{{ localStore.localData['history_ResetForm'] }}</XButton>
      <XButton :loading="submitLoading" @click="handleSubmit">{{ localStore.localData['history_FilterOrders'] }}</XButton>
    </div>
  </TheModal>
</template>
