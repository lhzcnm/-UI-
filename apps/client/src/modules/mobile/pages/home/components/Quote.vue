...
<template>
  <section class="h grid gap-5 md:gap-6 grid-cols-[repeat(auto-fill,minmax(280px,_1fr))]">
    <!-- 新机报价卡片 -->
      ...
      <div v-if="dialogVisible" @click="handleOverlayClick"
        ...
        <Transition name="zoom">
          <div v-if="dialogVisible" @click.stop
            class="w-full h-full flex flex-col bg-white dark:bg-black rounded-2xl shadow-2xl">
            <!-- 标题栏 -->
