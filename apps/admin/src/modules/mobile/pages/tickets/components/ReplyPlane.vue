...
<template>
  ...
  >
    <div class="flex flex-col h-full">
      <div class="flex-1 overflow-y-auto space-y-4 p-3">
        <div
      ...
      <div class="flex items-center space-x-2 border-y px-3 py-2">
      ...
      <div class="flex items-center space-x-2 p-3">
        <textarea
          v-model="msg"
          :class="twMerge(
            'size-full pl-2 text-base sm:text-sm bg-transparent',
