...
<template>
  <form class="space-y-4" @submit.prevent>
    <div>
      <label class="block text-label text-sm mb-1">服务组名称</label>
      <XInput v-model="form.category" placeholder="服务组名称" />
    </div>
    <div>
      <label class="block text-label text-sm mb-1">服务名称EN</label>
    ...
    <div>
      <label class="block text-label text-sm mb-1">禁用服务组</label>
      <XSwitch
