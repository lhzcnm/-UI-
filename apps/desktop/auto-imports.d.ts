...
declare global {
  ...
  const initAgGrid: typeof import('./src/utils/table')['initAgGrid']
  ...
  const theme: typeof import('./src/utils/table')['theme']
  ...
  const useSubmitStore: typeof import('./src/stores/submit')['useSubmitStore']
  ...
  const validate: typeof import('./src/utils/validator')['validate']
...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { ValidRule } from './src/utils/validator'
